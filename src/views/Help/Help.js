    ...
    return (
        <div className='App-main help'>
            <div className='help-container'>
                ...
                <p><b>3) </b>In the battle screen, your character has a couple of options: Basic Attack, Advanced Attack, and Special Attack (beta).</p><br/>
                ...
                <p><b>3.3) </b>The special attack is well... special. It has a bonus effect that may or may not even deal damage to your opponent. For instance, Francis' special attack doesn't deal damage but it increases her attack by 1.</p><br/>
